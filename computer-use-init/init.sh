...
TOOL_CODE=$(cat /app/computer-use-init/tools/computer_use_tools.py)
TOOL_PAYLOAD=$(python3 -c "
import json, sys
code = open('/app/computer-use-init/tools/computer_use_tools.py').read()
print(json.dumps({
    'id': 'ai_computer_use',
...
import json
code = open('/app/computer-use-init/functions/computer_link_filter.py').read()
print(json.dumps({
